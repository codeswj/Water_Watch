        ...
        <main className="flex-1 px-6 py-8 bg-[#f5f8fb]">
          <div className="mx-auto w-full max-w-6xl space-y-6">
            <section className="rounded-3xl bg-white p-6 shadow-sm border border-gray-200">
              <h1 className="text-3xl font-semibold text-gray-800 mb-1">Water Sources</h1>
              <p className="text-sm text-gray-500">Add, edit, or retire sources and their sensors.</p>
            </section>
